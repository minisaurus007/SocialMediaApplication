...
import edu.oakland.cse523.navapplication.client.Constants;
...
public class Common extends Application {
    ...
    public static final String ACTION_REGISTER = "edu.oakland.cse523.navapplication.REGISTER";
    ...
    public static String getPreferredEmail() {
        return prefs.getString("chat_email_id", email_arr.length==0 ? "jofiajose@gmail.com" : email_arr[0]);
    }
