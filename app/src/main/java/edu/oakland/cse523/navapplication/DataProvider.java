...
public class DataProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI_MESSAGES = Uri.parse("content://edu.oakland.cse523.navapplication.provider/messages");
    public static final Uri CONTENT_URI_PROFILE = Uri.parse("content://edu.oakland.cse523.navapplication.provider/profile");
    ...
    static {
        ...
        uriMatcher.addURI("edu.oakland.cse523.navapplication.provider", "messages", MESSAGES_ALLROWS);
        uriMatcher.addURI("edu.oakland.cse523.navapplication.provider", "messages/#", MESSAGES_SINGLE_ROW);
        uriMatcher.addURI("edu.oakland.cse523.navapplication.provider", "profile", PROFILE_ALLROWS);
        uriMatcher.addURI("edu.oakland.cse523.navapplication.provider", "profile/#", PROFILE_SINGLE_ROW);
    }
